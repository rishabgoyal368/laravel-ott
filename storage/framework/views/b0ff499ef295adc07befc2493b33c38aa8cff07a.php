  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div id="movie_id" class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
        <?php echo Form::label('title2', 'Movie ID'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/movie/edit.blade.php ENDPATH**/ ?>