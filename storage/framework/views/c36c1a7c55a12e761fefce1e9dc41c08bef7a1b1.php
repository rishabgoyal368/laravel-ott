<?php $__env->startSection('title','Added Tv Series'); ?>
    ...
    $(function () {
      ...
      var table = $('#tvTable').DataTable({
         ...
         scrollCollapse: true,
          ...
          ajax: "<?php echo e(route('addedTvSeries')); ?>",
          columns: [
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/tvseries/addedindex.blade.php ENDPATH**/ ?>