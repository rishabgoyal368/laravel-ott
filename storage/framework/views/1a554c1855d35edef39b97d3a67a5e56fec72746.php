<?php $__env->startSection('title','Create LiveTv'); ?>
<style type="text/css">
  body{
...
<div class="admin-form-main-block">
  <h4 class="admin-form-text"><a href="<?php echo e(url('admin/livetv')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Create LiveTv</h4>
  <div class="row">
    <div class="col-md-6">
      <div class="admin-form-block z-depth-1">
        ...
        <div id="movie_title" class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
          <?php echo Form::label('title', 'LiveTv Title'); ?>
        ...
        <div id="movie_slug" class="form-group<?php echo e($errors->has('slug') ? ' has-error' : ''); ?>">
          <?php echo Form::label('title', 'LiveTv Slug'); ?>

          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Enter livetv slug Eg:avatar-example"></i>
          <?php echo Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Please enter livetv slug']); ?>
        ...
        <div id="movie_id" style="display: none;" class="form-group<?php echo e($errors->has('title2') ? ' has-error' : ''); ?>">
          <?php echo Form::label('title', 'LiveTv ID'); ?>

          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter livetv ID (TMDB ID)"></i>
          <?php echo Form::text('title2', null, ['class' => 'form-control', 'placeholder' => 'Please enter livetv ID (TMDB ID)']); ?>
        ...
        <div class="form-group<?php echo e($errors->has('selecturl') ? ' has-error' : ''); ?>">
          ...
          <?php echo Form::select('selecturl', array('iframeurl' => 'IFrame URL',
       ...
       <div id="uploadvideo" style="display: none;" class="form-group<?php echo e($errors->has('upload_video') ? ' has-error' : ''); ?> input-file-block">
        ...
        <?php echo Form::file('upload_video', ['class' => 'input-file', 'id'=>'upload_video']); ?>
    ...
    <div  style="display: none" class="form-group<?php echo e($errors->has('series') ? ' has-error' : ''); ?>">
      <div class="row">
        <div class="col-xs-6">
...
<div class="form-group<?php echo e($errors->has('rating') ? ' has-error' : ''); ?>">
  ...
  <div class="form-group<?php echo e($errors->has('livetvicon') ? ' has-error' : ''); ?>">
    <div class="row">
      <div class="col-xs-6">
        <?php echo Form::label('livetvicon', 'Live Tv Icon show'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/livetv/create.blade.php ENDPATH**/ ?>