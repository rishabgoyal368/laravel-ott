  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div id="movie_slug" class="form-group<?php echo e($errors->has('slug') ? ' has-error' : ''); ?>">
        <?php echo Form::label('slug', 'Movie Slug'); ?>

        <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Enter movie slug Eg:Avatar"></i>
        <?php echo Form::text('slug', null, ['class' => 'form-control', 'placeholder' => 'Please enter movie slug']); ?>
      ...
      <div class="form-group<?php echo e($errors->has('selecturl') ? ' has-error' : ''); ?>">
        ...
        <?php echo Form::select('selecturl', array('iframeurl' => 'IFrame URL/Embed URL',
      ...
      <div style="display: none;" id="custom_url">
        <p style="color: red" class="inline info">Upload video not support wmv, Avi and mkv video format !</p>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <?php echo Form::label('upload_video', 'Upload Video in 360p'); ?> - <p class="inline info">Choose A Video</p>
          ...
          <div class="form-group<?php echo e($errors->has('url_480') ? ' has-error' : ''); ?>">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <?php echo Form::label('upload_video', 'Upload Video in 480p'); ?> - <p class="inline info">Choose A Video</p>
          ...
          <div class="form-group<?php echo e($errors->has('url_720') ? ' has-error' : ''); ?>">
            <div class="row">
              ...
              <div class="col-md-4">
                 <?php echo Form::label('upload_video', 'Upload Video in 720p'); ?> - <p class="inline info">Choose A Video</p>
    ...
    <div class="form-group<?php echo e($errors->has('featured') ? ' has-error' : ''); ?>">
      ...
      <div class="form-group<?php echo e($errors->has('is_protect') ? ' has-error' : ''); ?>">
        <div class="row">
          <div class="col-xs-6">
            <?php echo Form::label('is_protect', 'Protected Video ?'); ?>
      ...
      <div class="search form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?> is_protect" style="display: none;">
        <?php echo Form::label('password', 'Protected Password For Video'); ?>
...
<div id="custom_dtl" class="custom-dtl">
  <div class="form-group<?php echo e($errors->has('trailer_url') ? ' has-error' : ''); ?>">
    ...
    <?php echo Form::text('trailer_url', null, ['class' => 'form-control', 'placeholder'=>'Please enter your trailer url']); ?>
  ...
  <div class="form-group<?php echo e($errors->has('duration') ? ' has-error' : ''); ?>">
    ...
    <?php echo Form::text('duration', null, ['class' => 'form-control', 'placeholder'=>'Please enter movie duration in (mins) eg:160']); ?>
  ...
  <div class="form-group<?php echo e($errors->has('publish_year') ? ' has-error' : ''); ?>">
    ...
    <?php echo Form::number('publish_year', null, ['class' => 'form-control', 'min' => '1900']); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body admin-form-block">
        ...
        <div class="form-group<?php echo e($errors->has('image') ? ' has-error' : ''); ?> input-file-block">
          <?php echo Form::label('image', 'Actor Image'); ?> - <p class="inline info">Help block text</p>
          <?php echo Form::file('image', ['class' => 'input-file', 'id'=>'image']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/movie/create.blade.php ENDPATH**/ ?>