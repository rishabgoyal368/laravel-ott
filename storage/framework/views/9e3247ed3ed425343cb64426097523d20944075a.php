        ...
        <div class="row admin-form-block z-depth-1">
          ...
          <div class="payment-gateway-block">
              <div class="form-group">
                <div class="row">
                  <div class="col-xs-6">
                    <?php echo Form::label('captcha', 'GOOGLE CAPTCHA'); ?>
              ...
              <div style="<?php echo e($config->captcha==1 ? "" : "display: none"); ?>" id="captcha_box" class="row">
                <div class="col-md-6">
                  <div class="form-group<?php echo e($errors->has('NOCAPTCHA_SITEKEY') ? ' has-error' : ''); ?>">
                    <?php echo Form::label('NOCAPTCHA_SITEKEY', 'CAPTCHA SITE KEY'); ?>
                ...
                <div class="col-md-6">
                  <div class="search form-group<?php echo e($errors->has('NOCAPTCHA_SECRET') ? ' has-error' : ''); ?>">
                    <?php echo Form::label('NOCAPTCHA_SECRET', 'CAPTCHA SECRET KEY'); ?>
        ...
        <div class="row admin-form-block z-depth-1">
              ...
              <div style="<?php echo e($config->razorpay_payment==1 ? "" : "display: none"); ?>" id="razorpay_box" class="row">
                <div class="col-md-6">
                  <div class="form-group<?php echo e($errors->has('RAZOR_PAY_KEY') ? ' has-error' : ''); ?>">
                      <?php echo Form::label('RAZOR_PAY_KEY', 'RAZOR PAY KEY'); ?>
                ...
                <div class="col-md-6">
                  <div class="search form-group<?php echo e($errors->has('RAZOR_PAY_SECRET') ? ' has-error' : ''); ?>">
                          ...
                          <?php echo Form::label('RAZOR_PAY_SECRET', 'RAZOR PAY SECRET KEY'); ?>
          ...
          <div class="payment-gateway-block">
              <div class="form-group">
                  <div class="row">
                    <div class="col-xs-6">
                      <?php echo Form::label('coinpay', 'COIN PAYMENT'); ?>
              ...
              <div class="form-group">
                  <div class="row">
                    <div class="col-xs-6">
                      <?php echo Form::label('paystack', 'PAYSTACK PAYMENT'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/config/api.blade.php ENDPATH**/ ?>