...
<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="<?php echo e(route('home-block.create')); ?>" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Add Promotion Settings Block</a>
      <!-- Delete Modal -->
        ...
        <?php if($home_blocks): ?>
          ...
          <?php $__currentLoopData = $home_blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $home_block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr id="item-<?php echo e($home_block->id); ?>">
              ...
              <td><?php echo e($home_block->is_active == 1 ? 'Active' : 'Deactive'); ?></td>
              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/home-block/index.blade.php ENDPATH**/ ?>