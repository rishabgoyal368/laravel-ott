  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div id="movie_slug" class="form-group<?php echo e($errors->has('slug') ? ' has-error' : ''); ?>">
        <?php echo Form::label('slug', 'LiveTv Slug'); ?>
     ...
     <div id="uploadvideo" style="<?php echo e($video_link['upload_video']!='' ? '' : "display: none"); ?>" class="form-group<?php echo e($errors->has('upload_video') ? ' has-error' : ''); ?> input-file-block">
      ...
      <td><button type="button" name="add" id="add" class="btn btn-xs btn-success">
        <i class="fa fa-plus"></i>
            ...
            <div class="form-group<?php echo e($errors->has('livetvicon') ? ' has-error' : ''); ?>">
              <div class="row">
                <div class="col-xs-6">
                  <?php echo Form::label('livetvicon', 'LiveTv Icon Show'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/resources/views/admin/livetv/edit.blade.php ENDPATH**/ ?>