...
class AdsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->ad_location == "popup" || $request->ad_location == "onpause") {
            ...
            if ($file = $request->file('ad_image')) {
                ...
                $request->validate([
                    'ad_image' => 'required|image:png,jpg,jpeg | max:3500',
                ]);
                ...
                if ($request->ad_location == "popup") {
                    $request->validate([
                        ...
                        'time.required' => 'Please add start time',
                        'endtime.required' => 'Please add end time',
                    ]);
        ...
        $newad->save();
        return back()->with('updated', 'Ad Created Successfully !');
    ...
    public function updateAd(Request $request)
    {
        ...
        return back()->with('updated', 'Ad Settings Upated');
    }
    ...
    public function updatePopAd(Request $request)
    {
        ...
        return back()->with('updated', 'Popup Ad Setting Updated !');
    }
    ...
    public function delete($id)
    {
        ...
        return back()->with('deleted', 'Ad Deleted Successfully !');
    }
    ...
    public function updateADSOLO(Request $request, $id)
    {
        ...
        return redirect()->route('ads')->with('updated', 'Ad Updated Successfully');
    ...
    public function bulk_delete(Request $request)
    {
        ...
        return back()->with('deleted', 'Ads has been deleted');
    }
}
