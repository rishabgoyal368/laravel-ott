    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return \Datatables::of($tv_serieses)->addIndexColumn()->addColumn('checkbox', function ($tv_serieses) {
                ...
                $btn .= '<a href="' . route('tvseries.edit', $tv_serieses->id) . '" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
