...
class WishListController extends Controller
{
    ...
    public function showWishLists($slug)
    {
        ...
        if (isset($packageid)) {
            ...
            if (isset($userwish) && count($userwish) > 0) {
                ...
                return redirect('account/watchlist')->with('deleted', 'your Wishlist is Empty');
            }
        } else {
            return redirect('account/watchlist')->with('deleted', 'your Wishlist is Empty');
        }
        ...
        $ad = Adsense::first();
        return view('watchlists', compact('movies', 'type', 'ad', 'age'));
    }
    ...
    public function wishlistshow()
    {
        ...
        $ad = Adsense::first();
        return view('watchlists', compact('menu', 'ad', 'age'));
    }
