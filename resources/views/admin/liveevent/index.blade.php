...
@section('title','All Live Events')
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('liveevent.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Create LIVE Event</a>
      <!-- Delete Modal -->
