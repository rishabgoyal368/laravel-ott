...
<div class="admin-form-main-block">
  <h4 class="admin-form-text"><a href="{{url('admin/audio')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Create Audio</h4>
  <div class="row">
     <div class="col-md-6">
     <div class="admin-form-block z-depth-1">
        ...
        <div id="movie_title" class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
          ...
          <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Enter Audio title Eg:Avatar"></i>
          {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Please enter audio title']) !!}
        ...
        <div class="form-group{{ $errors->has('selecturl') ? ' has-error' : '' }}">
          ...
          {!! Form::select('selecturl', array('audiourl' => 'Audio URL',
           'upload_audio' => 'Upload Audio'), null, ['class' => 'form-control select2','id'=>'selecturl']) !!}
       ...
       {{-- upload video --}}
       <div id="upload_audio" style="display: none;" class="form-group{{ $errors->has('upload_audio') ? ' has-error' : '' }} input-file-block">
        {!! Form::label('upload_audio', 'Upload Audio') !!} - <p class="inline info">Choose A Audio</p>
