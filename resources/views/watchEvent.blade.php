...
<head>
	<title>{{__('staticwords.watchmovie')}} - {{ $liveevent->title }}</title>
...
<body style="background-color:#999999; padding:0px; margin:0px;">	
	...
	<ul id="trailer">
		...
		// $checkevent=Session::get('time_'.$event_id) ;
		// if (!is_null($checkevent)) {
		// 	$eid=$checkevent['event'];
  //     if ($eid==$event_id) {
  //     	$endtime=$checkevent['endtime'];
  //     }else{
  //     	$endtime='00:00:00';
  //     }
		// }else{
		...
		<ul data-ads="">
			...
			<div data-video-short-description="">
				<p class="minimalDarkCategoriesTitle"><span class="minimialDarkBold">{{__('staticwords.title')}}: </span>{{ $liveevent->title }}</p>
				<p class="minimalDarkCategoriesDescription"><span class="minimialDarkBold">{{__('staticwords.description')}}: </span>{{ $liveevent->detail }}</p>
			</div>
			<div>
				<p class="classicDarkThumbnailTitle">{{__('staticwords.title')}}: </span>{{ $liveevent->title }}</p>
				<p class="minimalDarkThumbnailDesc">{{__('staticwords.description')}}: </span>{{ $liveevent->detail }}</p>
			</div>
