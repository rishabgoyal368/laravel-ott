...
Route::get('/subscription/create', 'TestController@index')->name('subscription.create');
Route::post('order-post', 'TestController@orderPost')->name('order-post');
...
Route::middleware(['IsInstalled','isActive' ,'switch_languages', 'ip_block'])->group(function (){
    ...
    // general pages routes
     ...
     // Route::get('payment/braintree/test', 'BrainTreeController@get_bt');
    ...
    Route::group(['middleware' => ['web', 'auth' ,'switch_languages']], function () {
      ...
      Route::post('/manualpayment/verify/{planid}','ManualPaymentController@store');
    ...
    // notification route
      ...
      /**************** revenue report ************************/
      Route::get('admin/report/revenue', 'ReportController@get_revenue_report')->name('revenue.report');
      ...
      Route::resource('admin/manual_payment', 'ManualPaymentController');
